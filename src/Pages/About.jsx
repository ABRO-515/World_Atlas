  ...
  return (
    <main className="w-full h-full" >
      <div className="mx-4 my-6" >
        <h1 className="text-xl mt-12 text-center font-semibold mx-3 sm:mx-0" >Here are the Interesting Facts we are proud of</h1>

        {/* Grid */}
        <div className="grid lg:grid-cols-3 grid-cols-1  md:grid-cols-2 lg:gap-10 md:gap-6 my-8  md:mx-3 lg:mx-12 items-center">
          {/* Cards */}
          {CountryData.map((country) => {
            return (
              <div className="bg-[#171019] flex-col flex w-fit p-10  gap-1 my-4 rounded-[45px] container-card sm:mx-auto mx-6 border border-[#3d3c3c] " key={country.id}>
